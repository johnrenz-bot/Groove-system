                    ...
                    @if($validUrl || $selfieUrl)
                      <div class="bg-layer p-4 rounded-xl border border-divider/40">
                        ...
                        <div class="grid md:grid-cols-2 gap-4">
                          {{-- Valid ID --}}
                          @if($validUrl)
                            <div class="bg-card border border-divider/40 rounded-lg p-3">
                              <div class="flex items-center justify-between mb-2">
                              ...
                              @if($isImg($validUrl))
                                <div class="rounded-md media-fixed-sm">
                                  <img src="{{ $validUrl }}" alt="Valid ID" loading="lazy" class="w-full h-auto object-contain rounded-md cursor-zoom-in" data-lightbox="true"/>
                                </div>
                              @else
                                <iframe src="{{ $validUrl }}" class="w-full h-[420px] rounded-md" loading="lazy" referrerpolicy="no-referrer"></iframe>
                              @endif
                            </div>
                          @endif
                          ...
                          @if($selfieUrl)
                            <div class="bg-card border border-divider/40 rounded-lg p-3">
                              ...
                              @if($isImg($selfieUrl))
                                <div class="rounded-md media-fixed-sm">
                                  <img src="{{ $selfieUrl }}" alt="ID Selfie" loading="lazy" class="w-full h-auto object-contain rounded-md cursor-zoom-in" data-lightbox="true"/>
                                </div>
                              @else
                                <iframe src="{{ $selfieUrl }}" class="w-full h-[420px] rounded-md" loading="lazy" referrerpolicy="no-referrer"></iframe>
                              @endif
                            </div>
                          @endif
                        </div>
