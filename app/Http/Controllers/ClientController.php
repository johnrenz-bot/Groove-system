     ...
     public function Clientregister(Request $request)
{
     ...
     public function ClientStore(Request $request)
    {
        ...
        return back()->with('emailSent', true)->with('clientName', $request->firstname)->with('clientEmail', $validated['email']);
    }
    ...
    public function verificationStatus(Request $request)
{
    ...
    $verified = Client::where('email', $email)->value('email_verified') ? true : false;
